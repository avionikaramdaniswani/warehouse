...
import { Search, Save, Camera, QrCode, Package } from 'lucide-react';
              ...
              <Tabs defaultValue="manual" className="w-full">
                ...
                <TabsContent value="manual" className="space-y-6">
                      ...
                      <div className="absolute z-10 w-full mt-1 bg-white border rounded-md shadow-lg">
                        <ul className="py-1">
                          {suggestions.map((item) => (
                            <li 
                              key={item.tsCode} 
                              className="px-4 py-2 hover:bg-slate-100 cursor-pointer flex justify-between items-center border-b last:border-0"
                            ...
                            >
                              ...
                              <div className="text-xs bg-slate-100 px-2 py-1 rounded font-semibold">
                                Stok: {item.stok}
                              </div>
                            </li>
                          ))}
                  ...
                  <Button 
                    ...
                    disabled={!selectedItem || !formData.jumlah}
                  >
                    Simpan Penerimaan
                  </Button>
                </TabsContent>
