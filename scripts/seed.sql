...
--   Status: Critical (stok=0), Warning (stok <= safety_stok), Normal (stok > safety_stok)
-- ---------------------------------------------------------------------------
INSERT INTO items (item_code, ts_code, ms_code, nama, kategori, bin_loc, uom, stok, safety_stok, status, is_active, created_at, updated_at) VALUES
  ...
  ('TS-002','TS-002','529594',   'ACRYLIC,SIZE WIDTH=100CM,LENGTH=200CM,THK=3MM,COLOUR CLEAR',                                           'Civil Material',      NULL,        'EA',    0,  2, 'Critical', true, NOW(), NOW()),
  ...
  ('TS-005','TS-005','527703',   'AIR CONDITIONER,NON INVERTER,MDL CS-YN12TKJ,1.5PK,220V/1PHASE/50HZ,REFRIGERANT R32',                  'Mechanical Material', 'TS-CONT.E', 'UNIT',  5,  5, 'Warning',  true, NOW(), NOW()),
  ('TS-006','TS-006','527698',   'AIR CONDITIONER,NON INVERTER,MDL CS-YN18TKJ,2PK,220V/1PHASE/50HZ,REFRIGERANT R32',                    'Mechanical Material', 'TS-CONT.E', 'UNIT',  4,  5, 'Warning',  true, NOW(), NOW()),
  ...
  ('TS-008','TS-008','41600480', 'ALAT PEL,@LUSIN=12EA',                                                                                 'GH Consumable',       'TS-J.13',   'EA',    0,  2, 'Critical', true, NOW(), NOW()),
  ('TS-009','TS-009','127997',   'ANCHOR,PLASTIC,SIZE 10-12',                                                                             'Consumables',         'TS-J.17',   'EA',   17, 20, 'Warning',  true, NOW(), NOW()),
  ('TS-010','TS-010','116437',   'ANCHORS,DYNABOLT SLEEVE ANCHORS,BOLT DIA=M10,DH=12MM,LE=100MM,MATL GALV',                              'Consumables',         'TS-J.09',   'EA',    0, 10, 'Critical', true, NOW(), NOW()),
